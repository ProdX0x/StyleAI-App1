...
const App: React.FC = () => {
  ...
  const handleGarmentSelect = useCallback(async (garmentFile: File, garmentInfo: WardrobeItem) => {
    ...
    try {
      // Pass the isHighFidelity flag to the service
      const newImageUrl = await generateVirtualTryOnImage(displayImageUrl, garmentFile, isHighFidelity);
      ...
      // Cast err to any to satisfy TS requirement
      setError(getFriendlyErrorMessage(err as any, 'Failed to apply garment'));
    } finally {
      setIsLoading(false);
      setLoadingMessage('');
    }
  }, [displayImageUrl, isLoading, currentPoseIndex, outfitHistory, currentOutfitIndex, isHighFidelity]);
              ...
              >
                  ...
                  <div className="p-4 md:p-6 pb-20 overflow-y-auto flex-grow flex flex-col gap-8">
                    ...
                    <WardrobePanel
                      ...
                      onToggleHighFidelity={setIsHighFidelity}
                    />
                  </div>
              </aside>
            </main>
